...
function createIconSet(glyphMap : Object, fontFamily : string, fontFile : string) : Function {
  ...
  var Icon = React.createClass({
    ...
    render: function() {
      var { name, size, color, style, animated, ...props } = this.props;
      ...
      return (animated ? <Animated.Text {...props}>{glyph}{this.props.children}</Animated.Text> : <Text {...props}>{glyph}{this.props.children}</Text>);
    }
  });
